...
public interface SeasonTicketService {
    ...
    SeasonTicketDTO updateSeasonTicket(Long seasonTicketId, SeasonTicketParamsDTO seasonTicketParams) throws SeasonTicketException, ValidationException, RecordNotFoundException;
